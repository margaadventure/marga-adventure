            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-12 gap-8 md:gap-10 xl:gap-20 mb-12 md:mb-16">
                    ...
                    <div className="sm:col-span-2 md:col-span-3 xl:col-span-5 space-y-8 md:space-y-10 lg:space-y-12">
                        ...
                        <div>
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.4em] mb-4 md:mb-6 font-sans">Social Marga</p>
                            <div className="flex gap-3 md:gap-4">
                                <a href="https://www.facebook.com/profile.php?id=61585603559230" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 flex items-center justify-center text-gray-400 hover:text-brand transition-colors" aria-label="Visit our Facebook page">
                                ...
                                <a href="https://www.instagram.com/margaadventure/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 flex items-center justify-center text-gray-400 hover:text-[#E1306C] transition-colors" aria-label="Visit our Instagram profile">
                                    <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                ...
                                <a href="https://www.linkedin.com/in/margaadventure/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 flex items-center justify-center text-gray-400 hover:text-brand transition-colors" aria-label="Visit our LinkedIn profile">
                                    <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <div>
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.4em] mb-4 md:mb-6">Associations</p>
                    ...
                    <div className="xl:col-span-3 space-y-4 md:space-y-6 pt-2 md:pt-4">
                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.4em] mb-6 md:mb-10">Nepal Collection</p>
                    ...
                    <div className="xl:col-span-3 xl:col-start-10 space-y-4 md:space-y-6 pt-2 md:pt-4">
                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.4em] mb-6 md:mb-10 font-sans">Marga World</p>
                        {[
                            ...BHUTAN_NAV_ITEMS,
                            ...TIBET_NAV_ITEMS,
