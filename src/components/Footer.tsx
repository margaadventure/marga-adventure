            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-12 gap-8 md:gap-10 xl:gap-20 mb-12 md:mb-16">
                    ...
                    <div className="sm:col-span-2 md:col-span-3 xl:col-span-5 space-y-8 md:space-y-10 lg:space-y-12">
                        ...
                        <div>
                            <p className="text-[10px] font-bold text-gray-600 uppercase tracking-[0.4em] mb-4">{t('footer.sanctuaryHq')}</p>
                            <p className="text-sm text-gray-900 font-light leading-relaxed">Baneshwor, Kathmandu, Nepal</p>
                        </div>
                        <div>
                            <p className="text-[10px] font-bold text-gray-600 uppercase tracking-[0.4em] mb-4 md:mb-6 font-sans">{t('footer.socialMarga')}</p>
                            <div className="flex gap-3 md:gap-4">
                                <a href="https://www.facebook.com/margaadventure" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 flex items-center justify-center text-gray-500 hover:text-brand transition-colors" aria-label={t('footer.visitFacebook')}>
                                ...
                                <a href="https://www.instagram.com/margaadventure/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 flex items-center justify-center text-gray-500 hover:text-[#E1306C] transition-colors" aria-label={t('footer.visitInstagram')}>
                                    <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                ...
                                <a href="https://www.linkedin.com/in/margaadventure/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 flex items-center justify-center text-gray-500 hover:text-brand transition-colors" aria-label={t('footer.visitLinkedIn')}>
                                    <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <div>
                            <p className="text-[10px] font-bold text-gray-600 uppercase tracking-[0.4em] mb-4 md:mb-6">{t('footer.associations')}</p>
                    ...
                    <div className="xl:col-span-3 xl:col-start-10 space-y-4 md:space-y-6 pt-2 md:pt-4">
                        <p className="text-[10px] font-bold text-gray-600 uppercase tracking-[0.4em] mb-6 md:mb-10 font-sans">{t('destinations.margaWorld')}</p>
                        {[
                            ...BHUTAN_NAV_ITEMS,
                            ...TIBET_NAV_ITEMS,
                ...
                <div className="pt-10 md:pt-16 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-10">
                    <p className="text-[9px] font-bold text-gray-600 uppercase tracking-[0.6em] text-center md:text-left">
