        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-8 leading-[1.1]">
              Experience the <span className="text-brand italic font-serif">Extraordinary</span>
            </h2>
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="text-white max-w-2xl">
            <h3 className="text-4xl font-bold mb-6">Ready to start your {title.toLowerCase()} journey?</h3>
            <p className="text-white/80 text-lg font-light">Our experts are ready to craft a personalized itinerary just for you, tailored to your pace and preferences.</p>
          </div>
          <a href="/contact" className="bg-white text-brand px-12 py-5 rounded-none text-[10px] font-bold uppercase tracking-[0.4em] hover:bg-brand-light hover:text-white transition-all shadow-2xl shrink-0 flex items-center gap-6">
