...
const ACTIVITIES = [
  {
    ...
    description: 'Walk the ancient ridges where the mountains embrace the sky and stone paths tell stories of a thousand years. Here, the journey is measured not in miles, but in the warmth of shared smiles and the steam of tea by a village hearth. Blend the thrill of the ascent with the deep peace of temple chants. In Nepal, every step draws you closer to the clouds, and every encounter brings you closer to home.',
    image: trekking1.src,
  ...
  },
  {
    ...
    description: 'Nepal is a sanctuary where the spirit finds its home. From the sacred birth of peace in Lumbini to the meditative silence of high-altitude monasteries, every breath here feels like a prayer. Immerse yourself in the rhythm of chanting monks and the stillness of the mountains. This is not just a retreat; it is a soulful journey to rediscover your inner light amidst the clouds.',
  ...
  {
    id: 'wildlife',
    title: 'Wings over the himalayas',
    subtitle: 'Wildlife & Birdwatching',
    description: 'Embark on a birdwatching journey through Nepal, a hidden sanctuary boasting over 900 avian species. From the tropical wetlands of Koshi Tappu to the alpine forests of the Annapurna region, this small nation offers a rare density of diverse habitats. Spot the endemic Spiny Babbler, the gleaming Himalayan Monal, and vast flocks of migratory waterfowl.',
    image: wildlife1.src,
  ...
  },
  {
    ...
    description: 'Nepal is a living masterpiece painted in light and shadow. Frame the golden dawn igniting the himalayan peaks and the ancient, mist-shrouded temples where time stands still. From the haunting gaze of a Sadhu to the raw power of a Bengal tiger, every shutter click captures a story of resilience and beauty. This is not just photography; it is a visual pilgrimage into the soul of the Himalayas.',
    image: photo1.src,
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24">
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">
            A land of infinite <span className="italic font-light text-brand">diversity</span>
          </h2>
          <p className="text-xl text-gray-500 font-light leading-relaxed">
            A land of infinite diversity where the air itself tasted of incense and ozone.The eternal spirituality in the environment grounds the soul.In the shadow of Everest, the atmosphere feels like prayer. Wander the cluttered, timeless alleys of Kathmandu where history lingers in the shadows, feel the wild, beating heart of the jungle in Chitwan, and find your center in the sacred silence of lumbini. This is not just a journey across the land, but a pilgrimage into the depths of wonder.</p>
        </div>
